...
そうなってくると、身も蓋もないですが、**そもそも仕事を持続しやすそうな職場を選べる力の有無が重要になってきます**。具体的には学歴を身につけて大企業に入るか、手に職をつけやすい資格を手に入れてその仕事をするかの二択です。結局、勉強が重要になってきます。私も学生時代は偶然、ガリ勉になりました。全国模試の偏差値で言えば 50 も行かなかったのですが、校内では首席でした。偏差値の低い学校に入って、そこで誰よりもガリ勉になることで相対的に強いポジションを築いていました――といっても、本書の読者は成人であり、学生時代はすでに越えているはずなので、このやり方は使えません。現実的には資格を取るか、修士や博士といった学位を取るかの二択です。ただ MASD が社会人と大学院生を両立するのは不可能でしょうから、実家に余裕があって、かつ一時期的に無職にならないと学位は取れないでしょう。
...
- MASD が持続的に仕事を行えるだけの環境に入るには勉強が重要
    - そういう環境に入れるだけの何かが必要 → 学歴か資格や学位 → いずれにしても勉強がものいう
- 一応、非凡な特技を買ってもらえる可能性もあるが、再現性がない

上記のアプローチができない場合は、個人で鍛えるしかありません。

個人で鍛えるとなった場合、重要なのは何を鍛えるかを見定めることです。すでに資格が存在するような、体系化されたジャンルは望ましくありません。個人では勝てないからです。どちらかと言えば体系化されていないか、されているがお金持ちの大手や一部組織しかリーチしてないようなジャンルが良いでしょう。最も鉄板なのは IT であり、フルリモートで働けるだけのスキルと知識を持っている場合、IT 後進国の日本では引っ張りだこになれます。そうでなくとも、Excel とマクロが使いこなせれば神扱いされるような職場も多いのです。海外の方はピンと来ないかもしれませんが、日本は fit to standard ではなく、自分達が考えた独自の仕様と仕組みを推進する傾向があって、その推進者が IT に関して無知なので、いつまで経っても無知なままでいることが多かったりします。フルリモートができる程度はさして難しくない水準ですが、これだけでもオーバーキルなのです。

★みたいなことを書いていきたい。AWS はダメ。プロマネは一部はあり、とかも
